...
export const Trips: React.FC<TripsProps> = ({ onNavigate, user }) => {
  ...
  // Form State
  const [newTrip, setNewTrip] = useState({ name: '', destination: '', startDate: '', endDate: '', coverImageUrl: '' });
  ...
  const handleCreateTrip = async (e: React.FormEvent) => {
    ...
    try {
        ...
        setNewTrip({ name: '', destination: '', startDate: '', endDate: '', coverImageUrl: '' });
      ...
      <div className="flex border-b border-gray-200 gap-6">
        <button 
          ...
          className={`pb-2 text-sm font-medium border-b-2 transition-colors ${
            activeTab === 'active' ? 'border-brand-600 text-brand-600' : 'border-transparent text-gray-500 hover:text-gray-700'
          }`}
        >
        ...
        <button 
          ...
          className={`pb-2 text-sm font-medium border-b-2 transition-colors ${
            activeTab === 'archived' ? 'border-brand-600 text-brand-600' : 'border-transparent text-gray-500 hover:text-gray-700'
          }`}
        >
